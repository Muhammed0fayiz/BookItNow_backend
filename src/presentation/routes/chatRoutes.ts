...
router.post("/onlineUser/:userId/:anotherId",authMiddleware,controller.onlineUser.bind(controller));
router.post("/offlineUser/:id",authMiddleware,controller.offlineUser.bind(controller));
